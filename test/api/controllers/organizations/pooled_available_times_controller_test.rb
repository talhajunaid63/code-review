require "test_helper"
class PooledAvailableTimesControllerTest < ActionDispatch::IntegrationTest
  include ApiHelper
  ...
  test "Index - returns pooled availability properly" do
    get v1_organization_pooled_available_times_path(@organization.id),
        headers: {
          "APP_TOKEN": "test_001",
    ...
    assert response_json.to_s.exclude? "Janet Whitehouse"
